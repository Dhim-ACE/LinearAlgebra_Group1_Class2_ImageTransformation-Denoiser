...
def transformation_page():
    st.title("Image Transformation (Translate, Scale, Skew, Rotate)")
    ...
    if uploaded_file is not None:
        ...
        rotation_angle = st.number_input("Rotation Angle (degrees)", min_value=-360, max_value=360, value=0.0)
        ...
        transformed_image = rotate_image(transformed_image, rotation_angle)
...
if __name__ == "__main__":
    page = st.sidebar.selectbox("Select a Page", ["1. Linear Algebra Project", "2. Image Transformation: Denoiser", "3. About Image Transformation", "4. Image Transformation (Translate, Scale, Skew, Rotate)"])
    ...
    if page == "1. Linear Algebra Project":
        ...
        about_page()
    elif page == "4. Image Transformation (Translate, Scale, Skew, Rotate)":
        transformation_page()
